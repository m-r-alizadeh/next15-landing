    ...
    return (
        <div className="py-24 px-4 overflow-clip">
            <div className="container max-w-7xl mx-auto">
                <h3 className="text-center text-white/85 text-xl">{t('title')}</h3>
                <div dir="ltr" className="flex overflow-hidden mt-12 [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)]">
                    <motion.div
                        animate={{ x: "-50%" }}
